...
export function ShapeSelector({ onClose, floatingMode }: CloseProp) {
  const ref = useRef<HTMLDivElement>(null);
  ...
  return (
    <div ref={ref}
      className="absolute z-50 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-2 animate-fade-in"
      style={floatingMode ? { top: 0, left: '110%' } : { top: '110%', left: 0 }}>
